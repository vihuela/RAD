package worldgo.common.viewmodel.util.view;
...
public class ParallaxRecyclerView extends RecyclerView {
    ...
    public ParallaxRecyclerView(final Context context, @Nullable AttributeSet attrs) {
        ...
        applyParallaxRecyclerViewForLinearLayout(this);
    }
    ...
    public static void applyParallaxRecyclerViewForLinearLayout(@NonNull RecyclerView recyclerView) {
