...
import worldgo.common.BuildConfig;
...
public class ViewModelHelper<T extends IView, R extends AbstractViewModel<T>> {
    ...
    public void performBinding(@NonNull final IView bindingView) {
        ...
        if (!viewDataBinding.setVariable(viewModelConfig.getViewModelVariableName(), getViewModel())) {
            //xml layout have under code ,java use [mBinding.getViewModel()]
            /**
             * <data>
                 <variable
                 name="viewModel"
                 type="worldgo.rad.vm.MainActivityVM" />
               </data>
             *
             * */
            String msg = "Binding variable wasn't set successfully. Probably viewModelVariableName of your " +
