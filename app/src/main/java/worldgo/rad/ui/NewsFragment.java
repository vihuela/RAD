...
public class NewsFragment extends BaseBindingFragment<BaseRefreshView, NewsFragmentVM, FragmentPagerItemBinding> implements BaseRefreshView<ImageListRequest.Res.Item> {
